...
namespace Edu.UI
{
    ...
    public class AppUserStore<TUser> : UserStore<TUser, ApplicationRole, string, IdentityUserLogin, IdentityUserRole, IdentityUserClaim>, IUserStore<TUser>, IUserStore<TUser, string>, IDisposable
        where TUser :IdentityUser
    {

        public AppUserStore(DbContext db) : base(db)
        {
